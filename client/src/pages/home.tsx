...
import {
  ...
  Printer, Cog, BoxesIcon, ScrollText, Search, Trash2, TrendingUp, Barcode, PackageMinus, Layers, Tag,
...
const ALL_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { icon: Tag,           label: "Etiquetas",        description: "Modelos de etiquetas",          href: "/admin/label-templates",          color: "text-pink-400",   bg: "bg-pink-500/15" },
...
const ROLE_MODULE_ACCESS: Record<string, string[]> = {
  administrador: [
    ...
    "/admin/limpeza","/supervisor/print-settings","/admin/kpi-operadores","/supervisor/separation-settings","/admin/label-templates",
  ],
  supervisor: [
    "/wms/recebimento","/wms/checkin","/wms/transferencia","/wms/retirada","/wms/adicao","/wms/contagem","/wms/enderecos","/wms/produtos","/wms/codigos-barras",
    "/fila-pedidos","/supervisor/orders","/supervisor/routes","/supervisor/route-orders","/supervisor/exceptions",
    "/supervisor/users","/supervisor/reports","/supervisor/audit",
    "/supervisor/codigos-barras","/admin/kpi-operadores","/supervisor/separation-settings","/admin/label-templates",
  ],
...
function buildAllowedHrefs(role: string, customModules?: string[] | null): string[] {
  ...
  if (role === "administrador") return [...new Set([...base, "/admin/permissoes","/admin/limpeza","/supervisor/print-settings","/admin/kpi-operadores","/supervisor/separation-settings","/admin/label-templates"])];
  if (role === "supervisor")    return [...new Set([...base, "/admin/kpi-operadores","/supervisor/separation-settings","/admin/label-templates"])];
  return base;
}
